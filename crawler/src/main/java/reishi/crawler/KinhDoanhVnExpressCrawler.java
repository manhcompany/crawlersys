 ...
 *
 */
public class KinhDoanhVnExpressCrawler extends VnExpressCrawler {
    ...
    private static final CrawlerDomain domain = CrawlerDomain.KINHDOANH_VNEXPRESS;
    ...
    public KinhDoanhVnExpressCrawler(String url) {
        super(url, START,
                CONTAINS,
                NOT_CONTAINS,
                DIV_TITLE,
